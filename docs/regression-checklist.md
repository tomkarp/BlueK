...
| GUI-48 | Öffentlich lesbare Properties mit `private set` zeigen im Objektinspektor weiterhin das Stift-Symbol, dieses ist deaktiviert und erklärt per Hover, dass der Setter privat ist | Metadaten-/Kotlite-Smoke und Typecheck | Browser-Interaktion/visuelle Abnahme offen |
