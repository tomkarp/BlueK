...
| GUI-48 | Öffentlich lesbare Properties mit `private set` zeigen im Objektinspektor weiterhin das Stift-Symbol, dieses ist deaktiviert und erklärt per Hover, dass der Setter privat ist | Chromium-Test grün: Symbol sichtbar/deaktiviert, Tooltip, Klick und Doppelklick ohne Editierung; Metadaten-/Kotlite-Smoke und Typecheck | Abgesichert |
