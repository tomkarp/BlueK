...
| GUI-26 | Cmd/Ctrl-Shift-I formatiert die komplette Kotlin-Datei mit dem lokalen ktfmt-WASM-Formatter; normale Tab-/Shift-Tab-Einrückung bleibt separat | Chromium-Test grün: 2/2 für Ctrl und Cmd; Typecheck grün; Build enthält Worker und WASM-Artefakte lokal | Abgesichert |
