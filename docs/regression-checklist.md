...
| GUI-48 | Private Attribute werden im Objektinspektor durch eine klar graue Zeile unterschieden, behalten aber die normale dunkle Schrift; öffentlich lesbare Properties mit `private set` zeigen weiterhin ein moderat abgesetztes, deaktiviertes Stift-Symbol mit Tooltip | Chromium-Test grün: private Zeile mit normaler Schriftfarbe, Symbol, Sperrung, Tooltip, Klick und Doppelklick ohne Editierung; Metadaten-/Kotlite-Smoke und Typecheck | Abgesichert |
