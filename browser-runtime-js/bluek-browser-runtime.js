...
export class World {
  ...
  _findBackground() { const names = Object.getOwnPropertyNames(this); return names.map(name => this[name]).find(value => value instanceof Image && value !== this._background) || this._background; }
